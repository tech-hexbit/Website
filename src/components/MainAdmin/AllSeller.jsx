...
// components
import SelectSellerDetail from "../Admin/Sellers/Seller Main/SelectSellerDetail";

// MicroInteraction
import Load from "./../../MicroInteraction/LoadBlack"

// css
import SelCss from "../Admin/Css/Sellers.module.css";
  ...
  return (
    <>
      ...
      <div className={show.state ? "yesProductsPage" : "noProductsPage"}>
        {show ? (
        <SelectSellerDetail hide={hide} show={show} setLoad={props.setLoad} />
        ) : (
          ""
        )}
      </div>
