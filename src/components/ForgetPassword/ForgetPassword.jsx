        ...
        <>
            <div className={fpstyle.mainDiv}>
                    ...
                    <div className={fpstyle.loginDiv}>
                           {
                            forget && (
                                ...
                                <p className={fpstyle.forget} onClick={()=>setForget(false)}>Remembered your password?</p>
                                <Link className={fpstyle.login} to="/signIn" >Back to login</Link>
                                </div>
                            )
                           }
                            {
                                forget ? (
                                    ...
                                    <button><Link to="/changepwd" className={fpstyle.linkStyles}>{load ? <Load /> :"Continue"}</Link></button>
                                )
                            }
                ...
                <div className={fpstyle.right}>
                    <h1 className={fpstyle.headline}>Sell Smarter <br/> Sell Faster <br/> At HEXBIT</h1>
                    <div className={fpstyle.impCont}>
                       <h3 className={fpstyle.imp}>Important information:</h3>
                       <p className={fpstyle.line}>Please read the information below and then kindly share the requested information. </p>
                       <ul>
                    ...
                    <h2 className={fpstyle.terms}>Terms and conditions | FAQs | Contact us</h2>
                </div>
            </div>
        </>
    )
