...
const PrivacyContent = () => {
  return (
    <div className={styles.wrapper}>
      <h1>Privacy Policy for Hexbit.io</h1>

      <p>
        At HexBit, accessible from{" "}
        <a href="https://hexbit.io/">https://hexbit.io/</a>, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by HexBit
        ...
        shared and/or collect in HexBit. This policy is not applicable to any
      ...
      <p>
        HexBit follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, HexBit uses "cookies". These cookies are used to
      ...
      <p>
        ...
        advertising partners of HexBit. Third-party ad servers or ad networks
        uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on HexBit,
        ...
        that HexBit has no access to or control over these cookies that are used
      ...
      <p>
        HexBit's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        ...
        participate in, and/or monitor and guide their online activity. HexBit
