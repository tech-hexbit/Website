    ...
    <div className={odcss.orderdetails}>
      ...
      <div className={odcss.details}>
        ...
        <div className={odcss["shipping-address"]}>
          <div className={odcss["texxt-content"]}>
            <div className={odcss["customer-details1"]}>Shipping address</div>
            <div className={odcss.addressdetails}>
              <div className={odcss.name}>Regullion</div>
              <div className={odcss.phone1}>1*******8</div>
              <div className={odcss.adress}>
                <p className={odcss.adl1}>25</p>
                <p className={odcss.adl2}>7th Street</p>
                <p className={odcss.adl3}>TX</p>
              </div>
            </div>
          </div>
        </div>
        <div className={odcss["payment-details"]}>
          <div className={odcss["cust-details"]}>
            <div className={odcss["texxt-content"]}>
              <div className={odcss["customer-details1"]}>Payment details</div>
              <div className={odcss["details-list"]}>
                <div className={odcss.transactions}>
                  <div className={odcss["payment-method"]}>Transactions :</div>
                ...
                <div className={odcss.transactions}>
                  <div className={odcss["payment-method"]}>Card number :</div>
                  <div className={odcss.cno}>afaf</div>
                </div>
                <div className={odcss.transactions}>
                  <div className={odcss["payment-method"]}>Total amount :</div>
                  <div className={odcss.div3}>21</div>
                </div>
              </div>
            </div>
          </div>
